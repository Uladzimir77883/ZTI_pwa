...
const apiInfo = {
    ...
    key : '&appid=7e7c5942ca4a12ab6f2e2f4a06db9e36',
    units : '&units=metric',
    lang : '&lang=pl'
}
...
const getWeather = () => {
    ...
    if (apiInfoCity.trim() === '') {
    errorMsg.textContent = 'Wprowadź nazwę miasta.';
    return;}
    ...
    axios.get(apiURL).then((response) => {
        ...
        errorMsg.textContent = error.response?.data?.message || 'Wystąpił błąd. Spróbuj ponownie później.';
